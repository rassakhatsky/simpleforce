...
func (client *Client) Query(q string) (*QueryResult, error) {
	return client.QueryWithContext(context.Background(), q)
}

func (client *Client) QueryWithContext(ctx context.Context, q string) (*QueryResult, error) {
...
func (client *Client) ApexREST(method, path string, requestBody io.Reader) ([]byte, error) {
	return client.ApexRESTWithContext(context.Background(), method, path, requestBody)
}

func (client *Client) ApexRESTWithContext(ctx context.Context, method, path string, requestBody io.Reader) ([]byte, error) {
	if !client.isLoggedIn() {
		return nil, ErrAuthentication
	}
...
func (client *Client) LoginPassword(username, password, token string) error {
	return client.LoginPasswordWithContext(context.Background(), username, password, token)
}

func (client *Client) LoginPasswordWithContext(ctx context.Context, username, password, token string) error {
